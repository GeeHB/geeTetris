...
#ifdef TRACE_MODE
#define TRACE_POS_X     (CASIO_WIDTH - 100)
#define TRACE_POS_Y     (CASIO_HEIGHT - 40)
#define TRACE_WIDTH     100
#define TRACE_HEIGHT    15

#define TRACE(val, bk)      { drect(TRACE_POS_X, TRACE_POS_Y, TRACE_POS_X + TRACE_WIDTH - 1, TRACE_POS_Y + TRACE_HEIGHT -1, bk);dtext(TRACE_POS_X, TRACE_POS_Y, C_BLACK, val);dupdate();}
#else
#define TRACE(val, bk)      {}
